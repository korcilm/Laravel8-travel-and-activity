                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body mx-auto col-8">
                                ...
                                <form method="post" action="{{route('user_image_create',['content_id'=>$data->id])}}" enctype="multipart/form-data">
                                    @csrf
                                                               ...
                                                               <td>
                                                                ...
                                                                <td>
                                                                    <ul class="d-flex justify-content-center">
                                                                         <li><a href="{{route('user_image_delete',['id'=>$rs->id,'content_id'=>$data->id])}}" onclick="return confirm('Delete ! Are you sure?')" class="text-danger"><i class="ti-trash "></i></a></li>
                                                                    </ul>
                                                                </td>
                                                            </tr>
                                                        @endforeach
